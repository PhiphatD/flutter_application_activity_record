...
import '../../widgets/reward_confirmation_bottom_sheet.dart';
...
class _RewardDetailScreenState extends State<RewardDetailScreen> {
  ...
  void _handleRedeem() {
    ...
    if (widget.userPoints < widget.pointsCost) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Insufficient points. You need ${widget.pointsCost} points',
            style: GoogleFonts.poppins(),
          ),
    ...
    RewardConfirmationBottomSheet.show(
      ...
      imageUrl: widget.imageUrls.isNotEmpty ? widget.imageUrls[0] : null,
      ...
      onConfirm: () {
        ...
        widget
            .onRedeem(); // Call the redemption function (this will also switch to redeemed view)
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    final canRedeem =
        widget.stock > 0 && widget.userPoints >= widget.pointsCost;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFF4A80FF).withOpacity(0.1),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (widget.userPoints < widget.pointsCost)
                            Text(
                              'Need ${widget.pointsCost - widget.userPoints} more',
                              style: GoogleFonts.poppins(
                                fontSize: 12,
        ...
        child: ElevatedButton(
          ...
          child: Row(
            ...
            children: [
              Icon(
                Icons.card_giftcard,
                color: canRedeem ? Colors.amber[600] : Colors.grey[500],
                size: 20,
              ),
              const SizedBox(width: 8),
              Text(
                canRedeem
                    ? 'Redeem for ${widget.pointsCost} points'
                    : widget.stock <= 0
                    ? 'Out of Stock'
                    : 'Insufficient Points',
                style: GoogleFonts.poppins(
